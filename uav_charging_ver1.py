...
##### Read in data file containing the position of the nodes (hotels and vertices) #####
file_name = "hotel_sel"
...
# Disallow all node-to-node (including hotels) transitions. (No self-tours.)
for d in range(0, D):
...
plt.scatter(x_n, y_n, color='black', s=100, label='Vertex')
